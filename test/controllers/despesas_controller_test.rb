...
class DespesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create despesa" do
    assert_difference('Despesa.count') do
      post despesas_url, params: { despesa: { dt_despesa: @despesa.dt_despesa, dt_fechamento: @despesa.dt_fechamento, nm_despesa: @despesa.nm_despesa, tp_despesa: @despesa.tp_despesa, vl_despesa: @despesa.vl_despesa } }
    end
  ...
  test "should update despesa" do
    patch despesa_url(@despesa), params: { despesa: { dt_despesa: @despesa.dt_despesa, dt_fechamento: @despesa.dt_fechamento, nm_despesa: @despesa.nm_despesa, tp_despesa: @despesa.tp_despesa, vl_despesa: @despesa.vl_despesa } }
